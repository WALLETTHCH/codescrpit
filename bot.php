...
$h[]="user-agent:".json_decode(file_get_contents("cfg.json"),1)["useragent"];
$h[]="cookie:".json_decode(file_get_contents("cfg.json"),1)["cookie"];
...
loading(5,10000);
slow("\033[1;37;41m".$msg."\n",100000);
slow("\033[1;37;46mBalance:".bal()."\n",100000);
echo$reset;
slow_stater_line();
}else{
goto CAP;
